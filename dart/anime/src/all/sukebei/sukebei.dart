...
class Sukebei extends MProvider {
  Sukebei({required this.source});
  ...
  List<dynamic> getSourcePreferences() {
    return [
      ListPreference(
          ...
          summary: "",
          valueIndex: 0,
          entries: ["All categories", "Art", "Art - Anime", "Art - Doujinshi", "Art - Games", "Art - Manga", "Art - Pictures", "Real Life", "Real Life - Pictures", "Real Life - Videos"],
          entryValues: ["0_0", "1_0", "1_1", "1_2", "1_3", "1_4", "1_5", "2_0", "2_1", "2_2"]),
    ];
  }
...
Sukebei main(MSource source) {
  return Sukebei(source: source);
}
